...
function HeroSection() {
    ...
    // This function will arrange the portfolios based on the field provided
    // This function is shared between the HeroSection and SortOptions components
    ...
    // In useEffect we are filtering the data based on the selected tag, selected STMember and input value
    useEffect(() => {
        if(originalData){
            ...
            const final_arr = fileted_by_string.map((single)=>{
                ...
                //Setting the save field of the data.json 
    ...
    // In the return we have the Search Bar, for which we are using the AutoComplete component
    // In the AutoComplete component we are passing the tags and the function to set the selected tag

    // We have the SortOptions component which will be used to sort the portfolios
    // We are passing the function to sort the portfolios to the SortOptions component

    // We have the PortfolioCard component which will be used to display the portfolio cards
    // We are passing the portfolio data to the PortfolioCard component
    // We are also passing the function to save the like and remove the like to the PortfolioCard component
